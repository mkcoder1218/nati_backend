...
router.get('/sentiment/:sentiment', authenticateJWT, isOfficial, getSentimentLogsBySentiment);

// Get sentiment logs by category (admin/official only)
router.get('/category/:category', authenticateJWT, isOfficial, getSentimentLogsByCategory);

// Get sentiment logs by language (admin/official only)
router.get('/language/:language', authenticateJWT, isOfficial, getSentimentLogsByLanguage);
